...
from experiment_ppl import ExperimentPpl, AfterExperimentPpl
                    ...
                    for ci_rate in para['ci_rate']:
                        for simu_distr in para['simu_distr']:
                            for ci_accss in para['ci_accss']:
                                ...
                                experiment = ExperimentPpl(ppl_num=ppl_num, item_num=item_num, ewp_rate=ewp_rate,
                                ...
                                for iterat_times in para['iterat_times']:
                                    ...
                                    after_experiment = AfterExperimentPpl(experiment)
